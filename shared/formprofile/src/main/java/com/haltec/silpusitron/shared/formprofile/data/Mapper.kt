...
import com.haltec.silpusitron.common.util.phoneNumberFormat
import com.haltec.silpusitron.shared.form.domain.model.InputTextData
import com.haltec.silpusitron.shared.form.domain.model.TextValidationType
import com.haltec.silpusitron.shared.formprofile.data.remote.ProfileRequest
    ...
    return ProfileData(
        ...
        input = mapOf(
            ...
            FormProfileInputKey.PHONE_NUMBER to InputTextData(
                ...
                value = profileData.input[FormProfileInputKey.PHONE_NUMBER]?.value?.phoneNumberFormat()
            ),
...
fun Map<FormProfileInputKey, InputTextData<TextValidationType, String>>
    ...
    return ProfileRequest(
        ...
        phoneNumber = this[FormProfileInputKey.PHONE_NUMBER]?.value.phoneNumberFormat(),
