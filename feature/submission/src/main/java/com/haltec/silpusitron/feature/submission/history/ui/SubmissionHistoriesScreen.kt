...
import com.haltec.silpusitron.feature.submission.history.ui.parts.HistoryItemView
...
fun SubmissionHistoriesScreen(
    ...
    Column(
        ...
        SmallTopBar(
            ...
            Text(
                text = stringResource(R.string.doc_submission_history),
        ...
        ModalBottomSheet(
            ...
            Column(
                ...
                Button(
                    ...
                    ,
                    onClick = {
                        action(HistoryListUiAction.SetFilter(
